...
const AddNameModal: React.FC<AddNameModalProps> = ({ isLocationModalOpen, setIsLocationModalOpen }) => {
    ...
    <Modal
      title={
        <div className="flex items-center justify-between  pb-4">
          <h3 className="text-[22px] font-semibold text-primary">New Group Class</h3>
          <Button
            type="text"
    ...
    >
      <Form form={form} layout="vertical">
        <Form.Item
          ...
          <p className="text-[16px] text-primaryText font-medium pb-4"> Give your class a solid title. Remember, it will be visible to the public. </p>
           </div>}
          name="locationName"
